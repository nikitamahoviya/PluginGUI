...
public class Plugin {
	...
	protected void createContents() {
		...
		EntertVCellUser = new Text(shell, SWT.BORDER);
		EntertVCellUser.setBounds(162, 7, 106, 25);
		
		EntertVCellModel = new Text(shell, SWT.BORDER);
		EntertVCellModel.setBounds(162, 38, 106, 25);
